class RecipesController < ApplicationController
   def index
    ...
    if params[:search].present?
      ...
      @recipes = Recipe.where("name LIKE ? OR material LIKE ? OR CAST(kcalGe AS TEXT) LIKE? OR CAST(time AS TEXT) LIKE ? OR CAST(money AS TEXT) LIKE ? OR CAST(price AS TEXT) LIKE?", search_term, search_term, search_term)
