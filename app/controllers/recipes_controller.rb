class RecipesController < ApplicationController
   def index
    ...
    @recipes = Recipe.where("name LIKE ? OR material LIKE ? OR CAST(kcalGe AS TEXT) LIKE ? OR CAST(time AS TEXT) LIKE ? OR CAST(price AS TEXT) LIKE ? OR CAST(price AS TEXT) LIKE ?",
